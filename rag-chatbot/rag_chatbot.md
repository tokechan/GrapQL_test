...
https://github.com/jinwatanabe/next-rag-chatbot/blob/main/client/public/girl-background.jpg
このGithubから画像をダウンロードして、publicフォルダに入れる
...
```
これで、実装完了です！localhost:3000にアクセスして記事のスクショと同じような背景でかつUIが同じであれば成功です！
あとは、推しの子だけについては詳しく教えてくれるのでトライしましょう。
